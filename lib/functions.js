...
~> Ecchi : *${ecch()}*
~> T¨ªtulo japon¨ºs : *${title}*
~> Ortografia do T¨ªtulo : *${title_romaji}*
~> T¨ªtulo ingl¨ºs : *${title_english}*
~> Epis¨®dio : *${episode}*
~> Temporada  : *${season}*`});
	} catch (e) {
		console.log(e)
...
const simih = async (text) => {
	try {
		...
		return 'Simi nao sabe do que voce esta falando, uma lingua estranha, mana?'
	}
}
